<section class="<?php echo($url) ?>">
    <p>
        Si tiene alguna inquietud relacionada con Escena 70. Por favor comunicarse con alguna de las siguientes
        personas, indicando los siguientes datos
    </p>
    ...
    <form action="" id="form-contact" method="post">
        <div class="input-contend">
            ...
            <select name="dirigido" id="dirigido">
                ...
                <option value="juan2ramos@gmail.com">Coordinación Programadores - Gonzalo Bao</option>
            </select>
        </div>
        <div class="input-contend">
